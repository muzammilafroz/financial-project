...
Instructor: Prof. M. Parameswaran\\
Centre for Development Studies}
\date{April 2026}
\maketitle

\begin{abstract}
This paper studies Arunachal Pradesh's fiscal health over 1990-91 to 2026-27, with special attention to the recent five-year budget window from 2022-23 to 2026-27. The central empirical puzzle is a revenue-surplus paradox. Over the latest five years, the state records revenue surpluses averaging 15.9 percent of Gross State Domestic Product (GSDP) and interest payments averaging only 4.1 percent of revenue expenditure. Yet own revenue finances only 18.2 percent of revenue expenditure, and central transfers account for 85.9 percent of revenue receipts. A superficial fiscal-health reading would treat the state as unusually strong. The paper argues instead that headline strength is transfer-produced rather than autonomous. The analysis combines the Reserve Bank of India (RBI) State Finance Database, current-price GSDP data, the 2026-27 Arunachal Pradesh budget packet, PRS Legislative Research (PRS) budget material, and the 15th and 16th Finance Commission (FC) reports. It makes four contributions. First, it situates Arunachal Pradesh within the Indian fiscal federalism, North-Eastern and Himalayan states, and Finance Commission transfer literatures. Second, it extends the four core fiscal indicators into a long-run fiscal-history figure. Third, it fixes the own-tax buoyancy exercise by reporting unit-root and Engle-Granger diagnostics; the coefficient is informative but the cointegration evidence is not strong enough to support a causal long-run claim. Fourth, it treats the accounting gap between the broad PRS-style fiscal deficit, which reaches 10.5-11.0 percent of GSDP in 2025-26 and 2026-27, and the official deficit of 1.6-1.7 percent as the paper's main methodological finding. The gap arises because 50-year interest-free central capex loans under the Special Assistance to States for Capital Investment (SASCI) are excluded from the operative borrowing-ceiling calculation. Arunachal Pradesh is therefore best described as headline-strong but structurally transfer-dependent.

\vspace{0.5cm}
\noindent \textbf{JEL Classification:} H72, H77, O23, R11
\end{abstract}
...
The paper makes four contributions. First, it situates Arunachal Pradesh within the literature on Indian fiscal federalism, transfer dependence, and the special fiscal position of North-Eastern and Himalayan states. Second, it extends the recent five-year fiscal picture into a longer 1990-91 to 2026-27 fiscal history. Third, it separates the official state-budget deficit from the broader PRS Legislative Research (PRS)-style deficit created by central capex-loan accounting. Fourth, it links fiscal structure to the state's service-heavy and transfer-supported growth pattern. The novelty is not another descriptive state-budget summary. It is the demonstration that Arunachal Pradesh can simultaneously show large revenue surpluses, low interest burden, weak own-resource capacity, high capital spending, and limited structural transformation.

\section{Research Question and Contribution}

This paper evaluates Arunachal Pradesh's fiscal health and contributes specific conceptual advancements missing from the existing literature. Foundational scholarship on the state's finances, including the Rajiv Gandhi University evaluation prepared for the 15th Finance Commission \citep{nayak_rgu_2019}, correctly identifies Arunachal Pradesh's historical revenue surpluses, low own-tax capacity, and massive reliance on central transfers. Similarly, the RBI State Finances study \citep{rbi_state_finances_2023} highlights the broader phenomenon of transfer dependence among frontier states, while the 15th and 16th Finance Commission reports \citep{fifteenth_fc_2020,sixteenth_fc_2026} quantify the state's structural disadvantages, including its difficult terrain, and specify its vertical devolution parameters.

However, these existing documents leave critical, interrelated gaps regarding the state's fiscal trajectory into the late 2020s. None addresses the massive FRBM accounting gap created by Special Assistance to States for Capital Investment (SASCI) loans, which formally keeps the state within its borrowing limits while masking a much wider structural deficit. Additionally, previous analyses do not quantify the shock to the state's fiscal balance from the 16th Finance Commission's share-reduction formula, nor do they apply cointegration diagnostics (such as the Engle-Granger test) to qualify state-level tax buoyancy optimism. Finally, existing reviews have not explicitly mapped the state's long-run fiscal posture against empirically dated growth-regime breaks to track how a top-down fiscal approach coincides with service-heavy economic growth. 

This paper fills these specific gaps by anchoring the state's contemporary fiscal mechanics to its historical transfer-dependent growth profile. Ultimately, the paper provides a unified frontier-state framework that explains how high revenue surpluses can logically coexist with structural financing vulnerability and a narrow productive base.

\section{Literature Review}

\subsection{Fiscal federalism and vertical imbalance}

The starting point is the Indian fiscal federalism literature. Rao and Singh argue that India assigns large expenditure responsibilities to states while retaining major revenue powers at the Union level, producing persistent vertical fiscal imbalance that must be closed by Finance Commission devolution, grants, and other central transfers \citep{rao_singh_2005}. That argument is directly relevant to Arunachal Pradesh because the state is not merely a small administrative unit with temporary fiscal dependence. It is an extreme case of the structural mismatch built into the federal system. The state must finance public administration, roads, social services, and border-area infrastructure across difficult terrain, but its own tax base is narrow.

Rao's earlier work on state finances emphasises that state-level fiscal stress in India cannot be understood only from aggregate deficit ratios \citep{rao_2002}. The composition of revenue, the buoyancy of transfers, the burden of salaries and interest, and the crowding-out of capital expenditure all matter. This paper follows that logic. A revenue surplus is treated as an accounting result to be explained, not as sufficient evidence of fiscal autonomy. In Arunachal Pradesh, revenue surplus is large because transfers are large relative to current expenditure. That is different from the revenue surplus of a high-capacity industrial state.
...
\subsection{Fiscal responsibility rules, capital expenditure, and the quality of adjustment}

The fiscal-rule literature warns against treating numerical compliance as the whole story. Chakraborty and Dash show that analysts should evaluate rule-based fiscal consolidation in Indian states together with development spending and the quality of adjustment \citep{chakraborty_dash_2013}. This is directly relevant to Arunachal Pradesh because the state combines low official fiscal deficit with large capital outlay and large central capex loans. A strict deficit interpretation could understate financing dependence, while a strict deficit criticism could understate the developmental logic of concessional capital finance.

The RBI's \emph{State Finances: A Study of Budgets} series provides the operational framework for this kind of analysis: revenue balance, gross fiscal deficit, interest burden, committed expenditure, debt, and capital outlay are complementary indicators rather than substitutes \citep{rbi_state_finances_2023}. The present paper follows that multi-indicator approach. The four core ratios are necessary, but they are not sufficient for a publishable fiscal diagnosis.

\subsection{Arunachal Pradesh-specific evidence}

The Arunachal Pradesh-specific literature reinforces the same conclusion. The Rajiv Gandhi University evaluation prepared for the 15th Finance Commission documents that Arunachal Pradesh has long shown revenue surpluses and low own-tax capacity, while central transfers account for a very large share of aggregate revenue \citep{nayak_rgu_2019}. It also highlights hydro-power potential, administrative size, dependence on centrally sponsored schemes, and the importance of expanding own non-tax revenue. The present paper updates that earlier diagnosis to the 2026-27 budget environment and adds three new elements: the 16th Finance Commission share reduction, the central capex-loan reconciliation, and the long-run link between fiscal dependence and the state's broader growth pattern.
...
The fiscal-rule context also matters. The Arunachal Pradesh Fiscal Responsibility and Budget Management (FRBM) framework formally anchors fiscal discipline, but the 2026-27 budget documents show that interpretation depends on how central capex loans are treated. The broader deficit concept counts those loans in net borrowing. The official state-budget presentation nets them out for the operative fiscal-deficit discussion. The state's FRBM statement notes that the normal net-borrowing limit is 3 percent of GSDP for 2026-27 to 2030-31. It also states that Union on-lending under the Special Assistance to States for Capital Investment (SASCI) is over and above that limit. This accounting distinction materially changes the reported deficit ratio and therefore the substantive interpretation of compliance and sustainability.
...
The official documents include the 2026-27 \emph{Budget at a Glance}, \emph{Annual Financial Statement}, \emph{Fiscal Responsibility and Budget Management} statement, \emph{Demands for Grants}, and \emph{Budget Speech}, all obtained from the official Arunachal Pradesh budget portal. For current policy interpretation and deficit reconciliation, the paper also uses the PRS Arunachal Pradesh Budget Analysis 2026-27 and the PRS summary of the 16th Finance Commission report for 2026-31.

This hybrid design keeps the RBI database as the core quantitative source. It uses the official budget packet only where the RBI data do not yet provide the final budget year. It also uses official budget documents where the deficit definition must be reconciled explicitly.

Several limitations shape interpretation. First, the fiscal indicators for 2024-25 to 2026-27 are constructed from a hybrid of RBI database figures and official budget documents. The two sources use slightly different accounting conventions for capital receipts, and small reconciliation differences are possible. Second, GSDP denominators for 2025-26 and 2026-27 are Budget Estimate and projection figures respectively and will be revised as actuals become available. Third, the Engle-Granger diagnostic in the buoyancy regression does not establish cointegration at conventional significance levels, so the estimated elasticity should be read as a descriptive association. Fourth, the 2026-31 transfer trajectory in Table \ref{tab:fcpath} is an illustrative mechanical scenario, not a forecast. It holds non-Finance-Commission grants constant and applies a uniform growth assumption that will not hold in practice. Fifth, the cross-state comparison in Table \ref{tab:crossstate} uses 2023-24 account figures and therefore does not capture the post-16th Finance Commission transfer shift that dominates the 2026-27 budget analysis.

\begin{table}[H]
\centering
\caption{Data sources and coverage}
\small
\begin{tabular}{L{3.3cm}L{2.6cm}L{4.2cm}L{4.0cm}}
\toprule
Source & Coverage Period & Key Variables & Limitations \\
\midrule
RBI State Finances Database & 1990-91 to 2023-24 accounts (Arunachal Pradesh); 2023-24 accounts (comparators) & Revenue receipts, own tax, central taxes, grants, expenditure, capital outlay, interest, cross-state fiscal-dependence & Does not contain 2026-27 budget figures; comparison uses one account year, missing post-16th FC shift \\
Official 2026-27 Arunachal Pradesh budget documents & 2024-25 actuals, 2025-26 revised estimates, and 2026-27 budget estimates & Budget at a Glance, Annual Financial Statement, FRBM statement, Demands for Grants, Budget Speech, GSDP denominator, deficit presentation, and central capex loans & Budget and revised-estimate figures will change when audited accounts become available \\
PRS Legislative Research analyses and Finance Commission reports & 2026-27 budget and 2026-31 Finance Commission award period & PRS budget interpretation, 16th Finance Commission devolution shares, local-body grants, disaster grants, and transfer-rule context & PRS summaries aid interpretation but do not replace official accounts; 2026-31 trajectory is illustrative rather than a forecast \\
\bottomrule
\end{tabular}
\end{table}
...
The long-run fiscal-dependence ratio remains extremely high. In the most recent five-year window, central transfers account for 83.1 to 87.2 percent of revenue receipts. The latest official 2026-27 budget mix is especially revealing: central transfers amount to 83.1 percent of revenue receipts, while own revenue finances only 19.2 percent of revenue expenditure. Even in the latest budget, the state is far from fiscally self-financing. The final column below reports Centrally Sponsored Schemes (CSS) grants because these transfers are central to the current budget mix.
...
The dependence structure establishes the setting for the results. The next section turns from fiscal composition to fiscal interpretation. It examines the balances, accounting choices, and empirical extensions that explain the revenue-surplus paradox.

\section{Results}

This section presents results in four groups. Subsections 9.1 and 9.2 establish the headline fiscal picture and the revenue-surplus paradox. Subsection 9.3 addresses the FRBM accounting gap between the broad and official deficit measures. Subsections 9.4 through 9.7 present the four empirical extensions: expenditure quality, own-revenue elasticity, transfer-shock simulation, and cross-state comparison.
...
\caption{Own revenue relative to revenue expenditure. Note: 2026-27 values are drawn from official budget documents; all earlier years use the RBI State Finance Database.}
\label{fig:ownrev}
\end{figure}
...
The sustainability implication is therefore nuanced. SASCI loans are not equivalent to market debt: they reduce interest pressure, support capital expenditure, and are intentionally designed to relax infrastructure constraints. But they also reveal that capital formation is being sustained by an exceptional central channel -- one that is generous in its terms but finite in its predictability. If future Union support contracts, or if the projects it finances do not expand the state's economic or revenue base, the apparent FRBM comfort can mask a structural financing vulnerability.
...
\subsection{Own Revenue Elasticity}
...
The diagnostics substantially change the inferential claim. The ADF results require careful reading: both series are long upward trends, and the finite-sample power of ADF tests with a deterministic trend component can be unreliable in samples of this length. The Engle-Granger test is the more appropriate decision rule for the two-step regression, and it does not reject the null of no cointegration at the 5 percent level (p = 0.098). The coefficient of 1.69 should therefore not be interpreted as a precisely identified structural elasticity. It is a descriptive long-run association: in this 34-year sample, own-tax revenue has grown roughly proportionately with GSDP. The substantive finding is qualitative rather than causal. Own-tax revenue is not stagnant; it rises with the economy. The fiscal-autonomy problem is a level problem, not a growth-rate problem: the own-tax base began so small, and expenditure responsibilities are so transfer-financed, that proportionate growth has not narrowed the gap between own revenue and the state's spending need.
...
\subsection{Transfer Shock Simulation}
...
The simulation shows why the revenue surplus is fragile. If the old devolution share had been retained on the same implied divisible pool, the 2026-27 revenue balance would have been about Rs 9,948 crore. Under the 16th FC share, it is Rs 3,672 crore. The state remains in revenue surplus, but the margin is reduced by roughly Rs 6,276 crore. Under the official deficit definition, the same shock moves the state from a large counterfactual surplus to a deficit of about Rs 699 crore. This is the revenue-surplus paradox in dynamic form: the surplus is not only transfer-dependent in levels; it is highly sensitive to the rules governing transfers \citep{rao_singh_2005,rangarajan_srivastava_2011}.
...
The 16th Finance Commission simulation can be extended from a one-year counterfactual into a 2026-31 transfer path. The Commission's local-body and disaster-management grants for Arunachal Pradesh add up to Rs 2,548 crore over the award period: Rs 1,698 crore for rural local bodies, Rs 233 crore for urban local bodies, and Rs 616 crore for disaster management \citep{prs16fc}. Because the year-wise grant release path is not specified in the PRS summary, Table \ref{tab:fcpath} distributes these grants evenly and applies an illustrative 8 percent nominal growth path to tax devolution and revenue expenditure, holding non-Finance-Commission grants at the 2026-27 level. This is not a forecast. It is a transparent sensitivity path showing how much surplus remains under the new transfer regime.
...
\caption{Illustrative 16th Finance Commission transfer path. Projections for 2027-31 are illustrative; see Table \ref{tab:fcpath} assumptions.}
\label{fig:fcpath}
\end{figure}
...
\subsection{Cross-State Evidence}
...
Arunachal Pradesh's growth is real, but it is not transformation-led in the classical industrialisation sense. The companion paper on growth and inflation in Arunachal Pradesh identifies major growth shifts around 1995-96 and 2013-14. It also shows a sectoral pattern dominated by services and public administration rather than manufacturing. The fiscal evidence provides the counterpart to that growth pattern.
...
The timing of the growth breaks helps clarify the argument. The pre-1995-96 regime belongs to a period when revenue balances were already positive and fiscal dependence was already very high. Figure \ref{fig:longrun} does not show a transition from low to high fiscal dependence around 1995-96. Instead, the state begins the sample with central transfers already carrying most revenue receipts. The long-run fiscal-dependence series constructed from the RBI State Finance Database shows central transfers consistently above 80 percent of revenue receipts from 1990-91 onward -- the earliest year for which the data are available -- confirming that the structure predates the growth-regime changes identified in the companion analysis. Table 3 reports the recent five-year dependence ratios; the full historical series is not reproduced as a separate figure here to keep the paper focused on the five-year mandate window. The fiscal structure therefore predates the first growth-regime change rather than emerging as a response to it.

The post-2013-14 break tells a similar story. The long-run figure shows volatility in revenue balance around the early 2010s, but it does not show a durable fall in the fiscal-dependence ratio at the time of the growth break. Fiscal dependence remains high before and after the break. Revenue balance also rebounds after short-term movement. This pattern implies that the growth deceleration did not mechanically create the transfer-dependent fiscal structure. The structure was already in place and continued to shape the state's fiscal position after growth slowed.

The timing and structure of transfers suggest that directionality likely runs first from economic structure to fiscal structure, but this remains an interpretive claim in the absence of a formal causality test. A future extension would test this using transfer‑shock event studies and VAR/Granger diagnostics. Terrain, sparse settlement, high logistics costs, and a thin private sector limit both the industrial base and the tax base. These constraints make central transfers necessary for public services and infrastructure. Over time, however, the transfer system can create feedback effects. By providing a reliable alternative growth channel through public expenditure, it may reduce the urgency of private-sector development and own-revenue deepening.

This feedback should not be overstated as a simple dependency trap. Transfers also finance roads, administration, health, education, and border infrastructure that the state could not otherwise provide. The problem is not the existence of transfers. The problem is that transfer-financed expansion has not yet generated a broad productive base that can finance a much larger share of expenditure. The fiscal and growth narratives therefore meet at the same point: public expenditure supports activity, but the private economy remains too narrow to carry the fiscal system.

The comparative evidence is consistent with this interpretation. Among the six comparator states in Table \ref{tab:crossstate}, Assam and Himachal Pradesh have lower fiscal dependence than Arunachal Pradesh, Tripura, and Meghalaya. The companion growth analysis also suggests stronger post-2013 growth performance for these less dependent comparator states relative to the more frontier-like states. This is an observation rather than a causal claim. It is nevertheless consistent with the broader convergence literature. States with more autonomous fiscal capacity may be better positioned to sustain growth after transfer shocks.
...
The four policy directions that follow are not equally binding in the near term. The binding constraint for Arunachal Pradesh is own-tax administrative capacity, not the tax rate structure or the availability of new tax handles. GST compliance analytics, e-way bill enforcement, and digitised vehicle fees can be implemented within existing administrative frameworks and yield revenue returns faster than non-tax monetisation or formula-positioning with the Finance Commission. The other three directions -- non-tax revenue deepening, capital-expenditure productivity testing, and Finance Commission formula positioning -- are medium-to-long-term complements. They require either institutional capacity that must be built gradually or decisions outside the state's unilateral control. The near-term priority is therefore administrative, not legislative.
...
A state that records revenue surpluses averaging 15.9 percent of GSDP while financing only 18.2 percent of revenue expenditure from its own resources is not fiscally autonomous -- it is fiscally dependent under favourable accounting. Arunachal Pradesh's fiscal health, on the headline indicators, looks unusually strong. The extended analysis shows that the strength is produced by transfers and concessional capital support rather than by broad-based own-resource capacity. Yet more than four-fifths of revenue still comes from the Centre, and own revenue finances less than one-fifth of revenue expenditure even in the latest budget.
...
\bibitem[Bhatt and Scaramozzino(2013)]{bhatt_scaramozzino_2015}
Bhatt, Antra, and Pasquale Scaramozzino. 2013. ``Federal Transfers and Fiscal Discipline in India: An Empirical Evaluation.'' \emph{ADB Economics Working Paper Series} No. 343 (March).

\bibitem[Bird and Smart(2002)]{bird_smart_2002}
Bird, Richard M., and Michael Smart. 2002. ``Intergovernmental Fiscal Transfers: International Lessons for Developing Countries.'' \emph{World Development} 30(6): 899--912.

\bibitem[Chakraborty and Dash(2013)]{chakraborty_dash_2013}
Chakraborty, Pinaki, and Bharatee Bhusana Dash. 2013. ``Fiscal Reforms, Fiscal Rule and Development Spending: How Indian States have Performed?'' Working Paper No. 2013-122. National Institute of Public Finance and Policy, New Delhi.

\bibitem[Fifteenth Finance Commission(2020)]{fifteenth_fc_2020}
Fifteenth Finance Commission. 2020. \emph{Finance Commission in COVID Times: Report for 2021--26}. New Delhi: Government of India.

\bibitem[Government of Arunachal Pradesh(2026a)]{afs2026}
Government of Arunachal Pradesh. 2026. \emph{Annual Financial Statement for the Year 2026--27}. Itanagar: Department of Finance, Planning and Investment.

\bibitem[Government of Arunachal Pradesh(2026b)]{glance2026}
Government of Arunachal Pradesh. 2026. \emph{Budget at a Glance 2026--27}. Itanagar: Department of Finance, Planning and Investment.

\bibitem[Government of Arunachal Pradesh(2026c)]{frbm2026}
Government of Arunachal Pradesh. 2026. \emph{Statements under the Arunachal Pradesh Fiscal Responsibility and Budget Management Act, 2006}. Itanagar: Department of Finance, Planning and Investment.

\bibitem[Nayak et al.(2019)]{nayak_rgu_2019}
Nayak, S. K., N. C. Roy, A. Mitra, Vandana Upadhyay, Lijum Nochi, Maila Lama, Anup Kumar Das, Prasenjit Bujar Baruah, and Dil Bahadur Gurung. 2019. \emph{Outcome Evaluation of State Finance of Arunachal Pradesh}. Itanagar: Department of Economics, Rajiv Gandhi University.

\bibitem[Rangarajan and Srivastava(2004)]{rangarajan_srivastava_2011}
Rangarajan, C., and D. K. Srivastava. 2004. ``Fiscal Transfers in Australia: Review and Relevance to India.'' Working paper, National Institute of Public Finance and Policy.

\bibitem[Rao(2002)]{rao_2002}
Rao, M. Govinda. 2002. ``State Finances in India: Issues and Challenges.'' \emph{Economic and Political Weekly} 37(31): 3261--3271.

\bibitem[Rao and Singh(2006)]{rao_singh_2005}
Rao, M. Govinda, and Nirvikar Singh. 2006. ``The Political Economy of India's Fiscal Federal System and its Reform.'' Working Paper No. 623. University of California, Santa Cruz, Department of Economics.

\bibitem[Reserve Bank of India(2023)]{rbi_state_finances_2023}
Reserve Bank of India. 2023. \emph{State Finances: A Study of Budgets of 2023--24}. Mumbai: Reserve Bank of India. \url{https://www.rbi.org.in/Scripts/PublicationsView.aspx?id=22248}.

\bibitem[PRS Legislative Research(2026a)]{prsbudget2026}
PRS Legislative Research. 2026. \emph{Arunachal Pradesh Budget Analysis 2026--27}. \url{https://prsindia.org/budgets/states/arunachal-pradesh-budget-analysis-2026-27}.

\bibitem[PRS Legislative Research(2026b)]{prs16fc}
PRS Legislative Research. 2026. \emph{Report of the 16th Finance Commission for 2026--31: Summary}. \url{https://prsindia.org/policy/report-summaries/report-of-the-16th-finance-commission-for-2026-31}.

\bibitem[Sixteenth Finance Commission(2025)]{sixteenth_fc_2026}
Sixteenth Finance Commission. 2025. \emph{Report of the Sixteenth Finance Commission for 2026--31}. New Delhi: Government of India.

\bibitem[Comptroller and Auditor General of India(2025)]{cag2024}
Comptroller and Auditor General of India. 2025. \emph{State Finances Audit Report for the Year Ended 31 March 2024, Government of Arunachal Pradesh (Report No. 1 of 2025)}. New Delhi: Comptroller and Auditor General of India.
